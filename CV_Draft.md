...
- Built and deployed a semester-by-semester study hub for Technion Biotechnology and Food Engineering students.
...
**Python Tutor** | *Technion Student Community*

- Tutored undergraduate students in the Technion’s Python programming course.
- Built and maintained TechnionPrep’s Python study hub to centralize course materials and exercises.

**Technology Consultant** | *Hanan Shemesh Accounting*

- Integrated the WhatsApp Business API to automate client requests and routine communication.
- Digitized legacy paper records and introduced a more searchable operational workflow.
